...
exports.removeCollateralExample = void 0;
var client_1 = require("../v1/client");
var exampleUtils_1 = require("./exampleUtils");
var algosdk_1 = require("algosdk");
function removeCollateralExample(mnemonic) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var user, sender, key, buffer, IS_MAINNET, client, _a, symbol, assetBalance, txn, userActiveCollateral;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, client.prepareMintToCollateralTransactions(symbol, Math.floor(assetBalance * 0.1), sender)];
                case 8:
                    txn = _b.sent();
                ...
                case 9:
                    _b.sent();
                    return [4 /*yield*/, client.getUserState(sender)];
                case 10:
                    userActiveCollateral = (_b.sent())[symbol]["active_collateral_bank"];
                    return [4 /*yield*/, client.prepareRemoveCollateralTransactions(symbol, Math.floor(userActiveCollateral * 0.1), sender)];
                case 11:
                    txn = _b.sent();
                    txn.signWithPrivateKey(undefined, key);
                    return [4 /*yield*/, txn.submit(client.algod, true)];
...
exports.removeCollateralExample = removeCollateralExample;
