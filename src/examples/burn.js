    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 9:
                    _b.sent();
                    return [4 /*yield*/, client.getUserBalance(client.getMarket(symbol).getAsset().getBankAssetId())];
                case 10:
                    bankAssetBalance = _b.sent();
                    return [4 /*yield*/, client.prepareBurnTransactions(symbol, Math.floor(bankAssetBalance * 0.1), sender)];
                case 11:
                    txn = _b.sent();
                    txn.signWithPrivateKey(undefined, key);
                    return [4 /*yield*/, txn.submit(client.algod, true)];
...
exports.burnExample = burnExample;
