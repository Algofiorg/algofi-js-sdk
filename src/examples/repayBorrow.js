...
function repayBorrowExample(mnemonic) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var user, sender, key, buffer, IS_MAINNET, client, _a, symbol, assetBalance, txn;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 9:
                    _b.sent();
                    return [4 /*yield*/, client.prepareBorrowTransactions(symbol, Math.floor(1000), sender)];
                case 10:
                    txn = _b.sent();
                    txn.signWithPrivateKey(undefined, key);
                    return [4 /*yield*/, txn.submit(client.algod, true)];
                case 11:
                    _b.sent();
                    return [4 /*yield*/, client.prepareRepayBorrowTransactions(symbol, Math.floor(1000), sender)];
                case 12:
                    txn = _b.sent();
                    txn.signWithPrivateKey(undefined, key);
                    return [4 /*yield*/, txn.submit(client.algod, true)];
...
exports.repayBorrowExample = repayBorrowExample;
