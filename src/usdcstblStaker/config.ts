...
export const orderedAssets = ["ALGO", "USDC", "goBTC", "goETH", "STBL", "STBL-USDC-LP"]
export const extraAssets = ["BANK"]
export const orderedAssetsAndPlaceholders = ["ALGO", "USDC", "goBTC", "goETH", "STBL", "STBL-USDC-LP", "SEVN", "EGHT", "NINE", "TENN", "ELVN" ,"TWLV", "TRTN", "FRTN", "FVTN" , "SXTN"]
export const managerAppId = 485247444;
export const managerAddress = "IG3KDYTH7IB46DC5K4ME4Z3R46VJEFXFPHRHVV3KKBTULW5ODHPJL7ZFU4";
